...
This file is the shared instruction surface for coding agents, including Codex
and Claude Code. `CLAUDE.md` is kept as a compatibility pointer for tools that
...
truth it is measured against (see `docs/PROJECT.md` section 6.1).
...
See `docs/PROJECT.md` section 3 for the full architecture and the reasoning
behind it.
